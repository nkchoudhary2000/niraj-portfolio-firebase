...
import { X, Github, Globe, Image, Tag, CheckCircle2, AlertCircle, Link } from 'lucide-react';
...
export default function AddPortfolioModal({ isOpen, onClose, categories, defaultCategoryId }) {
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      ...
      // Add document directly to Firestore NoSQL collection
      const newItem = {
        title,
        description,
        githubUrl,
      ...
      await addDoc(collection(db, 'portfolio_items'), newItem);
        ...
        >
          ...
          <div className="mb-6">
            ...
            <p className="text-xs text-slate-400 mt-1">
              Add your web application, repository, or design grid showcase
            </p>
          </div>
          ...
          <form onSubmit={handleSubmit} className="space-y-4">
            ...
            <div>
              ...
              <input
                ...
                placeholder="e.g. AI Canvas Studio"
            ...
            <div>
              ...
              <textarea
                ...
                placeholder="Short summary of technologies used or features built..."
            ...
            <div>
              ...
              {thumbnailUrl && (
                <div className="mt-3 relative aspect-video w-full rounded-xl overflow-hidden border border-cyan-500/30 bg-slate-900">
                  ...
                  />
                  <div className="absolute top-2 left-2 px-2 py-0.5 rounded bg-black/60 text-[10px] text-cyan-300 font-mono">
            ...
            >
              {isSubmitting ? 'Saving to Firestore...' : 'Save & Publish Portfolio Project'}
            </button>
          </form>
        </motion.div>
      </div>
